...
def score(
    ...
    # Remove duplicates based on experiment and coordinates, keep the first occurrence
    solution = solution.drop_duplicates(subset=['experiment', 'x', 'y', 'z'], keep='first')
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Calculate F4 score for inference results")

    # Add arguments
    parser.add_argument("--gt", "-g", type=str, required=True, help="Ground truth picks csv file path")
    parser.add_argument("--submission", "-s", type=str, required=True, help="Submission picks csv file path")
